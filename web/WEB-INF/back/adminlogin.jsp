                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="widget-main">
                                    ...
                                    <form action="adminloginsubmit.action" id="admin_form">
                                        ...
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
														...
														<span class="block input-icon input-icon-right">
															...
															<input type="password" class="form-control" placeholder="Password" name="admin_pas"/>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <label class="inline">
                                                    ...
                                                    <span class="lbl"> 记住账号/密码</span>

                                                </label>



                                                <button type="button"  onclick="form_submit()" class="width-35 pull-right btn btn-sm btn-primary">
