        ...
        <div class="sidebar" id="sidebar">
            ...
            <script type="text/javascript">
                ...
                window.onload = function(){
                    ...
                    $("#send_invitation").addClass("active");
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div style="text-align: center">
                                        <form action="SetArtPic.action" enctype="multipart/form-data" method="post" id="picform">
                                            <input type="hidden" id="hiddenActId" name = "actId">
                                            <input type="file" placeholder="点击添加图片" name="pictureFileArt" id="pictureFileArt"><br/>
                                    ...
                                    <div style="text-align: center">
                                        <input  id="title" type="text" size="60" style="height: 40px">
                                    </div>
                                    ...
                                    <div style="text-align: right">
                                        <input type="button" value="提交" onclick="submit_information()">
                                    </div>
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        function submit_information() {
                                            var main_information = $("#editor1").html();
                                            var title = $("#title").val();
                                            if(title!=null &&main_information!=null &&title.trim()!="" &&main_information.trim()!="")
                                                $.post(
                                                "${pageContext.request.contextPath}/submit_information.action",
                                                {"main_information":main_information,"title":title},
                                                function (data) {

                                                    if(data.ResultState=="yes"){
                                                        //返回id值，然后通过id值来修改图片

                                                        $("#hiddenActId").attr("value",data.information_id);
                                                        $("#picform").submit();

                                                        alert("创建完成，点击确定后返回主界面");
                                                        setTimeout(function () {
