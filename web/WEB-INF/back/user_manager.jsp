                    ...
                    <div class="col-xs-12">
                        ...
                        <div>
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <c:forEach items="${userList.rows}" var="friend" varStatus="vs">
                                    <tr>
                                        ...
                                        <td class="hidden-480">${friend.password}</td>
                                        <td>
                                            ...
                                            <input type="button" onclick="DeleteUser('${friend.user_id}')" value="删除">
                                        </td>
                                    </tr>
                                </c:forEach>
                            ...
                            <div style="text-align: right">
                                <ul class="pagination">
                                    <c:if test="${userList.currentPage!=1}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/UserManager.action?currentPage=${userList.currentPage-1}">
                                    ...
                                    <c:forEach begin="1" end="${userList.totalPage}" var="fenyepage">
                                        <c:if test="${fenyepage == userList.currentPage}">
                                            <li class="active">
                                                <a href="UserManager.action?currentPage=${fenyepage}">${fenyepage}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${fenyepage != userList.currentPage}">
                                            <li>
